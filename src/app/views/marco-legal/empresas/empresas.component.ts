                ...
                columns: [
                  ...
                  },
                  {
                    ...
                    render: (data: EmpresaModel) => {
                      ...
                      const empresaHabilitada = data.id_estado === 1 ? '' : 'd-none';
                      ...
                      <button class="btn btn-outline-info btn-sm auditar-empresa ${btnAuditar} ${disabledAuditar} ${empresaHabilitada}" data-id="${data.id_empresa}" title="Auditar Empresa">
                          <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e3e3e3">
